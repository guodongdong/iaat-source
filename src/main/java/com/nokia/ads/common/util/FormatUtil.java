...
public class FormatUtil {
	private static final String initValue="0.00";	
	...
	public static  String asStringIp4(String var){
		return asString(toByteArray(var) ,'.', 10);
	}
	/**
	...
	public static String asStringZeroPad(byte[] array, char separator,
		...
		for (int i = start; i < (start + len); i++) {
			...
			final String s = Integer.toString((b < 0) ? b + 256 : b, radix)
					.toUpperCase();
	...
	public static String[] hexdump(byte[] array, int addressOffset,
		...
		return hexdump(array, addressOffset, dataOffset, doAddress, doText,
				doData, null);
	}
	...
	public static String hexdumpCombined(byte[] array, int addressOffset,
		...
		return hexdumpCombined(array, addressOffset, dataOffset, doAddress,
				doText, doData, null);
	}
