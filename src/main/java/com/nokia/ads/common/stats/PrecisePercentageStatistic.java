 ...
 */
public class PrecisePercentageStatistic
  extends PreciseTimingStatistic
{

  @Deprecated
  public PrecisePercentageStatistic( String name, String description, long period ) {
    this(name, description, period, RRDType.CACTI);
  }

  @Deprecated
  public PrecisePercentageStatistic( String name, String description ) {
    this(name, description, RRDType.CACTI);
  }

  @Deprecated
  public PrecisePercentageStatistic( String name, String graphiteName, String description, long period) {
  ...
  @Deprecated
  public PrecisePercentageStatistic( String name, String graphiteName, String description,
      ConversionType cactiConversionType,
      ConversionType graphiteConversionType,  boolean returnZeroForNoUpdates)
  {
   ...
   */
  public PrecisePercentageStatistic( String name, String description, long period, RRDType rrdType )
  {
    this( name, name, description, period, ConversionType.NONE, ConversionType.NONE, true, rrdType );
  }

  public PrecisePercentageStatistic( String name, String description, RRDType rrdType )
  {
    this( name, description, 300, rrdType );
  }

  public PrecisePercentageStatistic( String name, String description, ConversionType conversionType, RRDType rrdType )
  {
  ...
  public PrecisePercentageStatistic( String name, String graphiteName, String description, RRDType rrdType )
  {
   ...
   */
  @Override
  protected double processGet( long[] values, long[] totalRequests )
  {
    ...
    if ( totalGets > 0 )
    {
      pct = (100*((double)totalHits / totalGets));
    }
