 ...
 */
public abstract class TimingStatistic
  extends Statistic
{
  /**
  ...
  @Deprecated
  public TimingStatistic( String name, String graphiteName, String description, long duration, 
      ConversionType cactiConversionType, ConversionType graphiteConversionType,
      boolean returnZeroForNoUpdates) {
    this(name, graphiteName, description, duration, cactiConversionType, graphiteConversionType,
  ...
  @Deprecated
  public TimingStatistic( String name, String description, long duration) {
  ...
  public TimingStatistic( String name, String description, long duration, RRDType rrdType)
  {
    this( name, name, description, duration, rrdType);
  }

  public TimingStatistic( String name, String description, long duration, ConversionType conversionType, RRDType rrdType)
  {
    this(name, name, description, duration,
        conversionType, conversionType, false, rrdType);
  }
   ...
   */
  protected abstract long processGet( long[] values, long[] requests );
  ...
  public long get()
  {
    ...
    long result = processGet(tempValues, tempNumRequests );
    return result;
  }
