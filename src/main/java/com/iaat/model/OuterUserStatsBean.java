 ...
 * @version 1.0
 */
public class OuterUserStatsBean implements java.io.Serializable {

	
	private static final long serialVersionUID = 8512376259280506889L;
	private String uid;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof OuterUserStatsBean))
			return false;
		OuterUserStatsBean castOther = (OuterUserStatsBean) other;
