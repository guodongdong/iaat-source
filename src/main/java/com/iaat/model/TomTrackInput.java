 ...
 * @version 1.0
 */
public class TomTrackInput implements java.io.Serializable {

	
	private static final long serialVersionUID = 7633598004758358086L;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TomTrackInput))
			return false;
		TomTrackInput castOther = (TomTrackInput) other;
