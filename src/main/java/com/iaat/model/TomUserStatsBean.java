 ...
 * @version 1.0
 */
public class TomUserStatsBean implements java.io.Serializable {

	
	private static final long serialVersionUID = 3087338766544246098L;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TomUserStatsBean))
			return false;
		TomUserStatsBean castOther = (TomUserStatsBean) other;
