 ...
 * @version 1.0
 */
public class TotalUserSituationBean implements java.io.Serializable {


	
	private static final long serialVersionUID = 4110737113701614654L;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TotalUserSituationBean))
			return false;
		TotalUserSituationBean castOther = (TotalUserSituationBean) other;
