 ...
 * @version 1.0
 */
public class TomTrackOutput implements java.io.Serializable {

	
	private static final long serialVersionUID = 4474091791664340389L;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TomTrackOutput))
			return false;
		TomTrackOutput castOther = (TomTrackOutput) other;
