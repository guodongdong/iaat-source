 ...
 * @version 1.0
 */
public class TimeUserStatsBean implements java.io.Serializable {

	private static final long serialVersionUID = -3807665002798189475L;
	private String uid;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TimeUserStatsBean))
			return false;
		TimeUserStatsBean castOther = (TimeUserStatsBean) other;
