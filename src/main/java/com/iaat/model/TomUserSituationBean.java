 ...
 * @version 1.0
 */
public class TomUserSituationBean implements java.io.Serializable {

  
	
	private static final long serialVersionUID = 6829131835039063485L;
	private String uid;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TomUserSituationBean))
			return false;
		TomUserSituationBean castOther = (TomUserSituationBean) other;
