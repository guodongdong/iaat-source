...
public class TimeUserSituationBean implements java.io.Serializable {

	
	private static final long serialVersionUID = 236999057581390290L;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TimeUserSituationBean))
			return false;
		TimeUserSituationBean castOther = (TimeUserSituationBean) other;
